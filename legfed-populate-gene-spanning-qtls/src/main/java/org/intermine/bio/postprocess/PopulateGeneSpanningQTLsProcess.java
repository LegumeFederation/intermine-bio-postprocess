 ...
 * @author Sam Hokin
 */
public class PopulateGeneSpanningQTLsProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(PopulateGeneSpanningQTLsProcess.class);

    /**
     * Construct with an ObjectStoreWriter, read and write from the same ObjectStore
     * @param osw object store writer
     */
    public PopulateGeneSpanningQTLsProcess(ObjectStoreWriter osw) {
        super(osw);
    }

 ...
 * @author Sam Hokin
 */
public class PopulateQTLLinkageGroups {

    private static final Logger LOG = Logger.getLogger(PopulateQTLLinkageGroups.class);
     ...
     */
    public PopulateQTLLinkageGroups(ObjectStoreWriter osw) {
        this.osw = osw;
    }
     ...
     */
    public void populateQTLLinkageGroups() throws ObjectStoreException, IllegalAccessException {

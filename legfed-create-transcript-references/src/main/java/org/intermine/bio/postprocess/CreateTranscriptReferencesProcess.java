 ...
 * @author Sam Hokin
 */
public class CreateTranscriptReferencesProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(CreateTranscriptReferencesProcess.class);

    /**
     * Construct with an ObjectStoreWriter, read and write from the same ObjectStore
     * @param osw object store writer
     */
    public CreateTranscriptReferencesProcess(ObjectStoreWriter osw) {
        super(osw);
    }

 ...
 * @author Sam Hokin
 */
public class CreateQTLLinkageGroupRangesProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(CreateQTLLinkageGroupRangesProcess.class);

    /**
     * Construct with an ObjectStoreWriter, read and write from the same ObjectStore
     * @param osw object store writer
     */
    public CreateQTLLinkageGroupRangesProcess(ObjectStoreWriter osw) {
        super(osw);
    }

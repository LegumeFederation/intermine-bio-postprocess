        ...
        try {
            if ("create-chromosome-locations-and-lengths".equals(operation)) {
                ...
                CreateLocationOverlapIndex cloi =
                    new CreateLocationOverlapIndex(getObjectStoreWriter());
                cloi.create();
            } else if ("create-protein-gene-references".equals(operation)) {
                // Legume Federation
                ...
                pgsq.populateGeneSpanningQTLs();
            } else if ("populate-interpro-data".equals(operation)) {
                // Legume Federation
                PopulateInterproData pid = new PopulateInterproData(getObjectStoreWriter());
                pid.populateProteinDomains(); // populate ProteinDomain fields from Interpro
            } else if ("create-protein-domain-references".equals(operation)) {
                // Legume Federation

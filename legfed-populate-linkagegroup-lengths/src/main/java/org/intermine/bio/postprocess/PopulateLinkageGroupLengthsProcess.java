 ...
 * @author Sam Hokin
 */
public class PopulateLinkageGroupLengthsProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(PopulateLinkageGroupLengthsProcess.class);

    /**
     * Construct with an ObjectStoreWriter, read and write from the same ObjectStore
     * @param osw object store writer
     */
    public PopulateLinkageGroupLengthsProcess(ObjectStoreWriter osw) {
        super(osw);
    }
